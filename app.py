...
app.layout = html.Div([
    ...
    html.Iframe(id="embedded-pdf", src=base_path+"easy_question_distribution.pdf", height="200", width="1000"),
    html.Iframe(id="embedded-pdf", src=base_path+"easy_target_distribution.pdf", height="200", width="1000"),
    html.Iframe(id="embedded-pdf", src=base_path+"hard_question_distribution.pdf", height="200", width="1000"),
    html.Iframe(id="embedded-pdf", src=base_path+"hard_target_distribution.pdf", height="200", width="1000"),
    html.Iframe(id="embedded-pdf", src=base_path+"ambiguous_question_distribution.pdf", height="200", width="1000"),
    html.Iframe(id="embedded-pdf", src=base_path+"ambiguous_target_distribution.pdf", height="200", width="1000"),
